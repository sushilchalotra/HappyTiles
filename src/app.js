...
(function () {
  ...
  const Chess = (function () {
    ...
    function renderEvalResults(plan) {
      ...
      const titles = { pieces: 'Piece Moves', capture: 'Capturing', opening: 'Openings', traps: 'Smart Openings', mate: 'Checkmates', patterns: 'Mate Patterns', tactics: 'Tactics', endgame: 'Endgames' };
      let badges = '';
